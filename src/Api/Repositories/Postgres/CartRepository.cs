...
public sealed class CartRepository(DbConnectionFactory db)
{
    public async Task<Cart?> GetByIdAsync(
        Guid cartId,
        CancellationToken ct)
    {
        const string operationName = "get_by_id";
        ...
        try
        {
            const string sql = """
                                   ...
                                   FROM public.carts c
                                   LEFT JOIN public.cart_items ci ON c.cart_id = ci.cart_id AND c.tenant_id = ci.tenant_id
    ...
    public async Task<Guid> CreateCartAsync(
        ...
        CancellationToken ct)
    {
        const string operationName = "create_cart";
        CartRepositoryMetrics.RequestsTotal.WithLabels(operationName).Inc();
        CartRepositoryMetrics.ActiveOperations.WithLabels(operationName).Inc();
    ...
    public async Task<bool> UpdateCartDiscountAsync(
        ...
        CancellationToken ct)
    {
        const string operationName = "update_cart_discount";
        CartRepositoryMetrics.RequestsTotal.WithLabels(operationName).Inc();
        CartRepositoryMetrics.ActiveOperations.WithLabels(operationName).Inc();
        ...
        try
        {
            ...
            var rowsAffected = await conn.ExecuteAsync(
                new CommandDefinition(
                    sql,
                    new { CartId = cartId, DiscountId = discountId, Now = DateTime.UtcNow },
                    cancellationToken: ct
                ));
    ...
    public async Task<bool> DeleteCartAsync(
        ...
        CancellationToken ct)
    {
        const string operationName = "delete_cart";
        CartRepositoryMetrics.RequestsTotal.WithLabels(operationName).Inc();
        CartRepositoryMetrics.ActiveOperations.WithLabels(operationName).Inc();
        ...
        {
            const string sql = """
                                   DELETE FROM public.cart_items WHERE cart_id = @CartId;
                                   DELETE FROM public.carts WHERE cart_id = @CartId;
                               """;
    ...
    public async Task<Guid> AddItemToCartAsync(
        ...
        CancellationToken ct)
    {
        const string operationName = "add_item_to_cart";
        CartRepositoryMetrics.RequestsTotal.WithLabels(operationName).Inc();
        CartRepositoryMetrics.ActiveOperations.WithLabels(operationName).Inc();
        ...
        try
        {
            const string sql = """
                                   ...
                                   UPDATE public.carts SET updated_at = @Now WHERE cart_id = @CartId;
                               """;
            ...
            CartRepositoryMetrics.RowsAffected.WithLabels(operationName).Observe(2); // INSERT + UPDATE
            return cartItemId;
        }
        catch (Exception ex)
        {
    ...
    public async Task<bool> RemoveItemFromCartAsync(
        ...
        CancellationToken ct)
    {
        const string operationName = "remove_item_from_cart";
        CartRepositoryMetrics.RequestsTotal.WithLabels(operationName).Inc();
        CartRepositoryMetrics.ActiveOperations.WithLabels(operationName).Inc();
        ...
        try
        {
            ...
            var rowsAffected = await conn.ExecuteAsync(
                new CommandDefinition(
                    sql,
                    new { CartItemId = cartItemId, Now = DateTime.UtcNow },
                    cancellationToken: ct
                ));
    ...
    public async Task<bool> UpdateCartItemQuantityAsync(
        ...
        CancellationToken ct)
    {
        const string operationName = "update_cart_item_quantity";
        CartRepositoryMetrics.RequestsTotal.WithLabels(operationName).Inc();
        CartRepositoryMetrics.ActiveOperations.WithLabels(operationName).Inc();
        ...
        try
        {
            ...
            var rowsAffected = await conn.ExecuteAsync(
                new CommandDefinition(
                    sql,
                    new { CartItemId = cartItemId, Quantity = quantity, Now = DateTime.UtcNow },
                    cancellationToken: ct
                ));
